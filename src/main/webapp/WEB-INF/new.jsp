...
<body class="animsition animsition">
	<div class="home-1" id="page">
		...
		<ul>
			...
			<li><a href="person/index.html">Center</a></li>
		</ul>
		</nav>
		...
		<div class="banner banner-image-fit-screen">
			<div class="rev_slider slider-home-1" id="slider_1">
				<ul>
					<li><img class="rev-slidebg" src="images/slider/1.jpg"
						alt="demo" data-bgposition="center center" data-bgfit="cover"
		...
		<div class="container">
			<div class="row">
				<div class="product-category-grid-style-1">
					<div class="row">
						<div class="col-sm-4">
							<a href="#"> <figure class="product-category-item">
								<div class="thumbnail">
			...
			<div class="row">
				<div
					...
					<div class="product product-style-2">
						<div class="img-wrapper">
							<a href="#"> <img class="img-responsive"
								src="images/product/isotope-01.jpg" alt="product thumbnail" />
							</a>
							<div class="product-control-wrapper bottom-right">
								...
								<div class="wrapper-control-item item-wish-list">
									<a class="js-wish-list js-notify-add-wish-list" href="#"> <span
								...
								<div
									...
									<svg x="0px" y="0px" width="36px" height="32px"
										viewbox="0 0 36 32"> <path
										stroke-dasharray="19.79 19.79" fill="none"
										,="," stroke-width="2" stroke-linecap="square"
										stroke-miterlimit="10"
										d="M9,17l3.9,3.9c0.1,0.1,0.2,0.1,0.3,0L23,11"></path> </svg>
								</div>
							</div>
							...
							<span class="price">$2.00</span> </figcaption>
						</div>
					</div>
					</figure>
					...
					<div class="product product-style-2">
						<div class="img-wrapper">
							<a href="#"> <img class="img-responsive"
								src="images/product/isotope-03.jpg" alt="product thumbnail" />
							</a>
							<div class="product-control-wrapper bottom-right">
								<div class="wrapper-control-item">
									<a class="js-quick-view" href="#" type="button"
							...
							<span class="price">$3.20</span> </figcaption>
						</div>
					</div>
					</figure>
					<figure class="item">
					<div class="product product-style-2">
						<div class="img-wrapper">
							<a href="#"> <img class="img-responsive"
								src="images/product/isotope-02.jpg" alt="product thumbnail" />
							</a>
							<div class="product-control-wrapper bottom-right">
								<div class="wrapper-control-item">
									<a class="js-quick-view" href="#" type="button"
							...
							<span class="price">$3.10</span> </figcaption>
						</div>
					</div>
					</figure>
					<figure class="item">
					<div class="product product-style-2">
						<div class="img-wrapper">
							<a href="#"> <img class="img-responsive"
								src="images/product/isotope-04.jpg" alt="product thumbnail" />
							</a>
							<div class="product-control-wrapper bottom-right">
								<div class="wrapper-control-item">
									<a class="js-quick-view" href="#" type="button"
							...
							<span class="price">$1.10</span> </figcaption>
						</div>
					</div>
					</figure>
					<figure class="item">
					<div class="product product-style-2">
						<div class="img-wrapper">
							<a href="#"> <img class="img-responsive"
								src="images/product/isotope-05.jpg" alt="product thumbnail" />
							</a>
							<div class="product-control-wrapper bottom-right">
								<div class="wrapper-control-item">
									<a class="js-quick-view" href="#" type="button"
		...
		<div class="call-to-action-style-1">
			<img class="rellax bg-overlay" src="images/call-to-action/1.jpg"
				alt="" />
			...
			<div class="row">
				<div class="row blog-h reverse flex one-row multi-row-sm">
					<div class="col-md-4">
						<div class="post">
							<div class="img-wrapper js-set-bg-blog-thumb">
								<a href="#"> <img src="images/blog/01.jpg" alt="Image" />
								</a>
							</div>
							<div class="desc">
								<h4>
					...
					<div class="col-md-4">
						<div class="post">
							<div class="img-wrapper js-set-bg-blog-thumb">
								<a href="#"> <img src="images/blog/02.jpg" alt="Image" />
								</a>
							</div>
							<div class="desc">
								<h4>
					...
					<div class="col-md-4">
						<div class="post">
							<div class="img-wrapper js-set-bg-blog-thumb">
								<a href="#"> <img src="images/blog/03.jpg" alt="Image" />
								</a>
							</div>
							<div class="desc">
								<h4>
								...
								<p>Praesent efficitur felis eu luctus vestibulum. In hac
									habitasse platea dictumst. Nam egestas eu nisl ac pellentesque.
									Duis congue suscipit lorem vel congue.</p>
							</div>
						</div>
					</div>
				</div>
	...
	<div class="call-to-action-style-2">
		<div class="wrapper-carousel-background">
			<img src="images/call-to-action/1-1.jpg" alt="" /> <img
				src="images/call-to-action/1-2.jpg" alt="" /> <img
				src="images/call-to-action/1-3.jpg" alt="" /> <img
				src="images/call-to-action/1-4.jpg" alt="" />
		</div>
		<div class="overlay-call-to-action"></div>
		...
		<div class="row">
			<div class="footer-style-1-inner">
				<div class="widget-footer widget-text col-first col-small">
					<a href="#"> <img class="logo-footer" src="images/logo.png"
						alt="Logo Organic" />
					</a>
				...
				<div class="copy-right-inner">
					...
					<div class="widget widget-footer widget-footer-creadit-card">
						<ul class="list-unstyle">
							<li><a href="#"> <img
									src="images/icons/creadit-card-01.png" alt="creadit card" />
							</a></li>
							<li><a href="#"> <img
									src="images/icons/creadit-card-02.png" alt="creadit card" />
							</a></li>
							<li><a href="#"> <img
									src="images/icons/creadit-card-03.png" alt="creadit card" />
							</a></li>
							<li><a href="#"> <img
									src="images/icons/creadit-card-04.png" alt="creadit card" />
							</a></li>
						</ul>
					</div>
				</div>
						...
						<div class="col-md-6">
							<div class="woocommerce-product-gallery">
								<div class="main-carousel-product-quick-view">
									<div class="item">
										<img class="img-responsive" src="images/product/01.jpg"
											alt="product thumbnail" />
									</div>
									<div class="item">
										<img class="img-responsive" src="images/product/02.jpg"
											alt="product thumbnail" />
									</div>
									<div class="item">
										<img class="img-responsive" src="images/product/03.jpg"
											alt="product thumbnail" />
									</div>
									<div class="item">
										<img class="img-responsive" src="images/product/04.jpg"
											alt="product thumbnail" />
									</div>
									<div class="item">
										<img class="img-responsive" src="images/product/05.jpg"
											alt="product thumbnail" />
									</div>
								</div>
