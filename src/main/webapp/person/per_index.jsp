		...
		<div class="center">
			<div class="col-main">
						...
						<div class="wrap-list">
							...
							<div class="m-order">
								<div class="s-bar">
									...
									<a class="i-load-more-item-shadow" href="order.jsp">All</a>
								</div>
								<ul>
									<li><a href="order.jsp"><i><img src="../images/769/pay.png"/></i><span>Payment</span></a></li>
									<li><a href="order.jsp"><i><img src="../images/769/send.png"/></i><span>Delivery<em class="m-num">1</em></span></a></li>
									<li><a href="order.jsp"><i><img src="../images/769/receive.png"/></i><span>Pick up</span></a></li>
									<li><a href="order.jsp"><i><img src="../images/769/comment.png"/></i><span>Comment<em class="m-num">3</em></span></a></li>
									<li><a href="change.jsp"><i><img src="../images/769/refund.png"/></i><span>Change</span></a></li>
								</ul>
							</div>
						</div>
					</div>
				...
				<div class="footer-bd">
    			   ...
    			   <em>Â© 2015-2025 fightduck.com none rights reserved</em>
    				</p >
				</div>
				</div>
			</div>
